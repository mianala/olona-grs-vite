...
export default function MainSideNav() {
  return (
    <div className="flex flex-col justify-between h-screen relative shadow-sm">
      <motion.button
        className="btn btn-circle absolute w-6 h-2 -right-3 top-4"
        whileTap={{
          rotate: -180,
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100 grid place-items-center">
