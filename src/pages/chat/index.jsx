      ...
      <div class="main flex-1 flex flex-col">
        <div class="flex-1 flex h-full">
          <div class="sidebar hidden lg:flex w-1/4 flex-2 flex-col pr-6">
            <div class="hidden lg:block heading flex-2 p-4">
              <h1 class="text-3xl text-gray-700 mb-4">Messages</h1>
            </div>
            ...
            <div class="flex-1 h-full overflow-auto px-2">
              <div class="cursor-pointer bg-white hover:bg-slate-200 p-4 flex">
                <div class="flex-2">
                ...
                <div class="flex-1 px-2">
                  <div class="truncate w-32">
                    <span class="text-gray-800 font-bold">Ryann Remo</span>
                  </div>
                  <div>
