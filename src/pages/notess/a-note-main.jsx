...
const NoteMain = () => {
    const [categories, setCategories] = useState(['Marketing', 'Shopping', 'Ads', 'Posts', 'Video', 'Memo'])
    ...
    return <div className='grid grid-cols-[1fr_3fr]'>
        ...
        <Container notes={notes} currentCategory={currentCategory} addNote={addNote} categories={categories} />
    </div>
}
